...
def main():
    ...
    encode_parser.add_argument("payload", help="String payload to packetize.")
    ...
    if args.command == "decode":
        ...
        if args.json:
            output_data = {
                "raw": hex(val),
                "label": hex(Word.from_int(val, p_type).label),
        ...
        try:
            p = Arinc615Packetizer(args.payload.encode("utf-8"))
            words = p.to_words()
